#include "Ecal/EcalWABRecRemProcessor.h"

namespace ecal {

void EcalWABRecRemProcessor::onNewRun(const ldmx::RunHeader &rh) {
...
void EcalWABRecRemProcessor::onProcessEnd() {
...
void EcalWABRecRemProcessor::configure(
...
}  // end EcalWABRecRemProcessor::produce

/* Calculate where trajectory intersects ECAL layers using position and
 * momentum at scoring plane */
std::vector<ldmx::XYCoords> EcalWABRecRemProcessor::getTrajectory(
  ...
  return positions;
}  // end EcalWABRecRemProcessor::getTrajectory

}  // end namespace ecal

DECLARE_PRODUCER(ecal::EcalWABRecRemProcessor);