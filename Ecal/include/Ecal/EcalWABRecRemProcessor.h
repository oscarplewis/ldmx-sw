...
#ifndef EVENTPROC_ECALWABRECREMPROCESSOR_H_
#define EVENTPROC_ECALWABRECREMPROCESSOR_H_
...
/**
 * @class EcalWABRecRemProcessor
 * @brief Discards Ecal reconstructed hits from the recoil electron for WAB
 * event processing.
 */
class EcalWABRecRemProcessor : public framework::Producer {
 public:
  using XYCoords = ldmx::XYCoords;

  EcalWABRecRemProcessor(const std::string& name, framework::Process& process)
      : Producer(name, process) {}

  virtual ~EcalWABRecRemProcessor() {}
